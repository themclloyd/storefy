    ...
    <SidebarProvider defaultOpen={!isMobile}>
      ...
      <SidebarInset>
        <div className="flex flex-col h-screen">
          {/* Mobile Hamburger Menu - Only show on mobile when needed */}
          <div className="md:hidden flex items-center justify-between p-2 border-b bg-background/95 backdrop-blur">
