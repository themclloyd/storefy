...
import { Store, User, KeyRound, ArrowLeft } from 'lucide-react';
          ...
          <div className="space-y-4">
            ...
            <div className="bg-muted/50 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-medium">Access Levels:</span>
              </div>
              <div className="space-y-1 text-xs text-muted-foreground">
                <div className="flex items-center justify-between">
                  <span>Manager:</span>
                  <Badge variant="outline" className="text-xs">POS + Inventory + Reports</Badge>
                </div>
                <div className="flex items-center justify-between">
                  <span>Cashier:</span>
